...
public class KingsGameActivity extends Activity implements
	...
	public void start(View v) {
		Intent king = new Intent("com.cincosolutions.myfiesta.KINGSGAME");
		startActivityForResult(king, ACTIVITY_EDIT);
		overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
	}
