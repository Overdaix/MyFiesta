...
public class DrinksMenu extends Activity implements SimpleGestureListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final ViewGroup viewToLoad = (ViewGroup)llPrefContainer.getParent();
		final View view = getLayoutInflater().inflate(R.layout.drinksprefs, viewToLoad, false);
		...
		btnPrefs.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (booPrefClicked == false) {
					...
					final ViewGroup ingredientParent = (ViewGroup)llIngredient.getParent();
					View view = getLayoutInflater().inflate(R.layout.ingredientrowview, ingredientParent, false);
					ingredientParent.addView(view);
