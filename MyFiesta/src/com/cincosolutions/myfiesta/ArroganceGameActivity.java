...
public class ArroganceGameActivity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_arrogance_game);
	...
	public void start(View v) {
		Intent start = new Intent("com.cincosolutions.myfiesta.ARROGANCEGAME");
		startActivityForResult(start, ACTIVITY_EDIT);
		overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
	}
